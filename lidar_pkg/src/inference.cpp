...
PLUGINLIB_EXPORT_CLASS(lidar_pkg::Inference, nodelet::Nodelet)

namespace lidar_pkg
{
  void Inference::onInit()
  {
    ROS_INFO("Initialized Inference.");
    tensorflow::Tensor input(tensorflow::DT_FLOAT, tensorflow::TensorShape({1,20,128,128,2}));
    ros::NodeHandle& private_nh = getMTPrivateNodeHandle();
    // Set dirs variables
    std::string graphPath = "/home/bernard/catkin_ws/src/ROS_OGP/RealTimeEnvironmentPrediction/models/prednet_1.pb";
  ...
  void Inference::createPredictionAndPublish(std::vector<tensorflow::Tensor>& output)
  {
    ROS_INFO("Publishing");
    int grid_size = 128;
  ...
  void Inference::createTensorFromFrames(tensorflow::Tensor& input)
  {
